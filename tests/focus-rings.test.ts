...
// analysis and imaging results, the export preview and the message window's body
// all fell back to the browser's own ring that way.
//
...
const COVERING_STYLESHEET = "src/renderer/src/App.css";
